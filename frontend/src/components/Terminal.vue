        ...
        mainTerminalConfig() {
            this.terminal.onKey((e) => {
                ...
                if (e.key === "\r") {
                    ...
                    if (this.cursorPosition < this.terminalInputBuffer.length) {
                        this.terminal.write(
                            this.terminalInputBuffer[this.cursorPosition],
                        );
                        this.cursorPosition++;
                    }
                } else if (e.key === "\u001B\u005B\u0044") {
                    ...
                    e.key === "\u0016" ||
                    (e.domEvent?.ctrlKey && e.key.toLowerCase() === "v")
                ) {
                    // Ctrl + V
                    this.handlePaste();
                    ...
                    this.terminalInputBuffer =
                        textBeforeCursor + e.key + textAfterCursor;
                    this.terminal.write(
                        e.key +
                            textAfterCursor +
                            "\b".repeat(textAfterCursor.length),
                    );
                    this.cursorPosition++;
                }
            });
